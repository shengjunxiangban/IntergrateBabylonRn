        ...
        try {
            ...
            if (parsedData.transformNodes !== undefined && parsedData.transformNodes !== null) {
                for (var index = 0, cache = parsedData.transformNodes.length; index < cache; index++) {
                    var parsedJSONTransformNode = parsedData.transformNodes[index];
                    var parsedTransformNode = TransformNode.Parse(parsedJSONTransformNode, scene, rootUrl);
            ...
            if (parsedData.meshes !== undefined && parsedData.meshes !== null) {
                ...
                for (var index = 0, cache = scene.transformNodes.length; index < cache; index++) {
                    var transformNode = scene.transformNodes[index];
                    if (transformNode._waitingParentId !== null) {
                        var parent_1 = parsedIdToNodeMap.get(parseInt(transformNode._waitingParentId)) || null;
                        if (parent_1 === null) {
                            parent_1 = scene.getLastEntryById(transformNode._waitingParentId);
                        }
                ...
                for (var index = 0, cache = scene.meshes.length; index < cache; index++) {
                    ...
                    if (currentMesh._waitingParentId) {
                        var parent_2 = parsedIdToNodeMap.get(parseInt(currentMesh._waitingParentId)) || null;
                        if (parent_2 === null) {
                            parent_2 = scene.getLastEntryById(currentMesh._waitingParentId);
                        }
